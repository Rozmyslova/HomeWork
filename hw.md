...
## Требования к главе 3

В третья и последующая главы входят в основную част. 

в данном разделе должна быть приведены расчеты: *сопротивления оборудования - __трансформаторов, воздушных линий электропередачи, кабельных линий__, *токов короткого амыкания*, выбраны:
* выключатели;
* разъединители;
* токоограничивающие реакторы (при необходимости).

> __Важно!__ Необходимость установки токоограничивающих реакторов необходимо доказать!

Также необходимо рассчитать вторичную нагрузку на трансформаторы тока и напряжения. Выбрать их. 

Далее должен быть рассмотрен индивидуальный вопрос - расчет релейной защиты, установка специфического оборудоания и т.д.
